...
class Checkout_Confirmation(BrowserUtils):
    def __init__(self, driver):
        super().__init__(driver)    # step to get title , and initializing parent driver BU.PY / lec 97
        self.driver = driver
    ...
    def enter_delivery_address(self,countryName):
        ...
        wait.until(expected_conditions.presence_of_element_located(self.country_option)) # it doesnt need a * cos it expects tuple here and is just a driver
    ...
    def validate_order(self):
        ...
        assert "Success! Thank you!" in successText    # static message thats why written inside this page